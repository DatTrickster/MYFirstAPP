...
import { newArray,Totalhistory,objectarray } from '../values/values';
...
const Filter=[
  {key:1, value:'All Courses'},
  {key:2,value:'Six-Week Courses'},
...
const DATA = [
...

  {
    ...
    title: 'Life Skills',
    Price:1500,
    image: require('../images/Skills.png'),
    description: 'dummy data',
...
const SM = ({ navigation}) =>{
  ...
  const closeMenu = () => setVisible(false);
    ...
    const Item = ({title,image,Price,id,state}) => (
    ...
    <Pressable  style={{ fontSize: 20, padding: 5 ,color:'blue',alignSelf:'center',textAlign:'center',width:150}} onPress={()=>{
